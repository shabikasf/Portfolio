...
var skills=['JAVASCRIPT','REACT','JAVA','C/C++'];
var values=['60','40','80','80']
...
var typed = new Typed(".auto-type",{
    strings:["a Front-End Developer", "a Programmer", "a Reader","an Ailurophile"],
    typeSpeed:75,
    backSpeed:50,
    loop: true
});
...
const mypicEl = document.querySelector(".mypic");

mypicEl.addEventListener("contextmenu", (event)=>{
